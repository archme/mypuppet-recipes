pacman -U http://github.com/downloads/archme/mypkgbuilds/ruby1.8-augeas-0.3.0-1-any.pkg.tar.xz \
	http://github.com/downloads/archme/mypkgbuilds/ruby1.8-1.8.6_p399-1-i686.pkg.tar.xz \
	...
	http://github.com/downloads/archme/mypkgbuilds/augeas-0.7.1-1-i686.pkg.tar.xz
